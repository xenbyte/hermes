...
from hermes_utils.strings import get, _STRINGS


class TestGetDefaultLanguage:
    @patch('hermes_utils.strings.get_user_lang', return_value="en")
...
class TestGetDutchLanguage:
    @patch('hermes_utils.strings.get_user_lang', return_value="nl")
